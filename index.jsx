...
const TABS = [
    { key: 'all', title: 'Все' },
    { key: 'kitchen', title: 'Кухня' },
    { key: 'hall', title: 'Зал' },
    { key: 'lights', title: 'Лампочки' },
    { key: 'cameras', title: 'Камеры' }
];
                ...
                <ul role="tablist" className="section__tabs">
                    {TABS.map(tab => (
                        <li
                            ...
                            tabIndex={tab.key === activeTab ? '0' : undefined}
                            className={'section__tab' + (tab.key === activeTab ? ' section__tab_active' : '')}
                            id={`tab_${tab.key}`}
                            aria-controls={`panel_${tab.key}`}
